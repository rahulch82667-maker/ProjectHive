...
export default function CategoryBreakdown({ data }: CategoryBreakdownProps) {
  ...
  if (!data || data.length === 0) {
    return (
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <h3 className="text-lg font-semibold text-slate-900 mb-1">Revenue by Category</h3>
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      <h3 className="text-lg font-semibold text-slate-900 mb-1">Revenue by Category</h3>
      <p className="text-sm text-slate-500 mb-6">Breakdown across project categories</p>
