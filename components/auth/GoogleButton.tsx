...
export default function GoogleButton() {
  ...
  const { loading } = useAuth();                    // ← loading state
  ...
  return (
    <button
      ...
      disabled={loading}
      className="w-full flex items-center justify-center gap-3 bg-white border border-[#c8a882] rounded-lg py-2.5 px-4 text-[#3b1f0a] font-medium transition-colors duration-200 hover:bg-[#fdf6ee] focus:outline-none focus:ring-2 focus:ring-[#3b1f0a] focus:ring-offset-1 focus:border-transparent disabled:opacity-50"
    >
